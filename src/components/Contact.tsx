    ...
    <>
      <section id="contact" className="bg-gray-50 dark:bg-gray-800">
        <div className="relative max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-24 lg:px-6">
            <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl">{contactProps.title}</h1>
            <p className="mb-6 font-light lg:mb-8 md:text-lg lg:text-xl border-t border-gray-200 my-7 dark:border-gray-700 pt-8">
